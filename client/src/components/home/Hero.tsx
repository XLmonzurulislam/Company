        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
              <span className="text-secondary">GROW</span> YOUR<br />
              BUSINESS WITH US
            </h1>
            <p className="text-light-text mb-8 text-lg max-w-lg">
              Connect with verified ethical hackers to identify vulnerabilities and 
              secure your digital assets before malicious attackers find them.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/how-it-works">
                <Button variant="outline" className="w-full sm:w-auto border-light-text text-light-text hover:bg-white/10 hover:text-white px-6 py-6">
                  Learn More
                </Button>
              </Link>
            </div>
          ...
          <div className="md:w-1/2 relative">
            <div className="relative z-10 rounded-lg overflow-hidden shadow-2xl">
              <div className="bg-gray-300 rounded-lg h-80 flex items-center justify-center">
                <p className="text-gray-700 text-xl">Image</p>
              </div>
            </div>
